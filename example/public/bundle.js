	...
	var Modal = function (_React$Component) {
	  ...
	  _createClass(Modal, [{
	    ...
	    value: function render() {
	      ...
	      var closeBtn = _react2.default.createElement('div', { className: 'overlay-top' }, _react2.default.createElement('div', { className: 'overlay-close', title: 'Close',
	      ...
	      return _react2.default.createElement('div', { ref: 'overlay', className: closeClass,
	        onClick: this.handleOverlayClick.bind(this) }, closeBtn, _react2.default.createElement('div', { className: 'overlay-content' }, this.props.children));
	    }
	  }]);
